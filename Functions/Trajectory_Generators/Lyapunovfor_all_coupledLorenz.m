...
function [tvalues, Lyapunov_spectrum, Orbits] = Lyapunovfor_all_coupledLorenz(x0, t0, tf, k, coupling_strength, sigma, rho, beta, Adj)
...
evolution_LYA = zeros(k,n+1);
    ...
    for ITERLAP=1:k   %Main loop to compute Lyapunov
        ...
        [T, Y] = ode45(@(t,y) lorenz_all_coup_ext(t,y, Adj, coupling_strength, sigma, rho, beta), tspan, y0, options);
...
function f=lorenz_all_coup_ext(t,X, Adj, K, sigma, rho, beta)
